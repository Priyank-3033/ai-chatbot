  ...
  return (
    <section className="commerce-panel compact-commerce-panel">
      ...
      <div className="commerce-tabs">
        <button type="button" className={`commerce-tab ${activeTab === "wishlist" ? "active" : ""}`} onClick={() => setActiveTab("wishlist")}>Wishlist</button>
        <button type="button" className={`commerce-tab ${activeTab === "cart" ? "active" : ""}`} onClick={() => setActiveTab("cart")}>Cart</button>
        <button type="button" className={`commerce-tab ${activeTab === "checkout" ? "active" : ""}`} onClick={() => setActiveTab("checkout")}>Checkout</button>
        <button type="button" className={`commerce-tab ${activeTab === "orders" ? "active" : ""}`} onClick={() => setActiveTab("orders")}>Orders</button>
      </div>
